...
var onRequestDelete = /* @__PURE__ */ __name(async (ctx) => {
  requireAccess(ctx.request);
  const { slug } = ctx.params;
  const repo = new KvLinkRepository(ctx.env);
  const result = await DeleteLink(repo, slug);
  if (!result.deleted) {
    return json({ ok: false, error: "Not found", slug });
  }
...
// ../.wrangler/tmp/pages-m6LwOX/functionsRoutes-0.9569515056505256.mjs
var routes = [
  {
...
// ../../../../Users/albem/AppData/Local/npm-cache/_npx/0687088c2dae0f28/node_modules/path-to-regexp/dist.es2015/index.js
function lexer(str) {
  var tokens = [];
  var i = 0;
  while (i < str.length) {
...
// ../../../../Users/albem/AppData/Local/npm-cache/_npx/0687088c2dae0f28/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../../../../Users/albem/AppData/Local/npm-cache/_npx/0687088c2dae0f28/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../../../Users/albem/AppData/Local/npm-cache/_npx/0687088c2dae0f28/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-x1nRnE/middleware-insertion-facade.js
...
// ../../../../Users/albem/AppData/Local/npm-cache/_npx/0687088c2dae0f28/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-x1nRnE/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.09211049644501412.mjs.map
